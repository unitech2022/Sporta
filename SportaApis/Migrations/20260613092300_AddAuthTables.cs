        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerifiedOnPlatform = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    PreferredHand = table.Column<int>(type: "int", nullable: false),
                    CourtPosition = table.Column<int>(type: "int", nullable: false),
                    PreferredMatchType = table.Column<int>(type: "int", nullable: false),
                    PreferredPlayTime = table.Column<int>(type: "int", nullable: false),
                    PlayStartYear = table.Column<int>(type: "int", nullable: true),
                    Level = table.Column<int>(type: "int", nullable: false),
                    EloRating = table.Column<float>(type: "float", nullable: false),
                    ...
                    PeerRatingAverage = table.Column<float>(type: "float", nullable: false),
                    PeerRatingCount = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedLevel = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LevelAssessments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LevelAssessments_PlayerProfiles_PlayerProfileId",
                        column: x => x.PlayerProfileId,
                        principalTable: "PlayerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LevelAssessments_Users_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    PaidFullAmount = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TargetLevel = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    PlayerReview = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoachSessions_Courts_CourtId",
                        column: x => x.CourtId,
                        principalTable: "Courts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CoachSessions_Users_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinLevel = table.Column<float>(type: "float", nullable: false),
                    MaxLevel = table.Column<float>(type: "float", nullable: false),
                    PricePerPlayer = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    Notes = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "AmericanoMatches",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MatchId = table.Column<int>(type: "int", nullable: false),
                    AmericanoType = table.Column<int>(type: "int", nullable: false),
                    MinAllowedLevel = table.Column<float>(type: "float", nullable: false),
                    MaxAllowedLevel = table.Column<float>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmericanoMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmericanoMatches_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchPlayers_PlayerProfiles_PlayerProfileId",
                        column: x => x.PlayerProfileId,
                        principalTable: "PlayerProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchRatings_Users_RatedUserId",
                        column: x => x.RatedUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MatchRatings_Users_RaterId",
                        column: x => x.RaterId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AmericanoMatchId = table.Column<int>(type: "int", nullable: false),
                    RoundNumber = table.Column<int>(type: "int", nullable: false),
                    Team1Player1Id = table.Column<int>(type: "int", nullable: false),
                    Team1Player2Id = table.Column<int>(type: "int", nullable: false),
                    Team2Player1Id = table.Column<int>(type: "int", nullable: false),
                    Team2Player2Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmericanoRounds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmericanoRounds_AmericanoMatches_AmericanoMatchId",
                        column: x => x.AmericanoMatchId,
                        principalTable: "AmericanoMatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmericanoRounds_Users_Team1Player1Id",
                        column: x => x.Team1Player1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AmericanoRounds_Users_Team1Player2Id",
                        column: x => x.Team1Player2Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AmericanoRounds_Users_Team2Player1Id",
                        column: x => x.Team2Player1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AmericanoRounds_Users_Team2Player2Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmericanoMatches_MatchId",
                table: "AmericanoMatches",
                column: "MatchId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AmericanoRounds_AmericanoMatchId",
                table: "AmericanoRounds",
                column: "AmericanoMatchId");

            migrationBuilder.CreateIndex(
                name: "IX_AmericanoRounds_Team1Player1Id",
                table: "AmericanoRounds",
                column: "Team1Player1Id");

            migrationBuilder.CreateIndex(
                name: "IX_AmericanoRounds_Team1Player2Id",
                table: "AmericanoRounds",
                column: "Team1Player2Id");

            migrationBuilder.CreateIndex(
                name: "IX_AmericanoRounds_Team2Player1Id",
                table: "AmericanoRounds",
                column: "Team2Player1Id");

            migrationBuilder.CreateIndex(
                name: "IX_AmericanoRounds_Team2Player2Id",
                table: "AmericanoRounds",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoachSessions_CoachProfileId",
                table: "CoachSessions",
                column: "CoachProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CoachSessions_CourtId",
                table: "CoachSessions",
                column: "CourtId");

            migrationBuilder.CreateIndex(
                name: "IX_CoachSessions_PlayerId",
                table: "CoachSessions",
                column: "PlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LevelAssessments_CoachId",
                table: "LevelAssessments",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_LevelAssessments_PlayerProfileId",
                table: "LevelAssessments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchRatings_MatchId_RaterId_RatedUserId",
                table: "MatchRatings",
                columns: new[] { "MatchId", "RaterId", "RatedUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MatchRatings_RatedUserId",
                table: "MatchRatings",
                column: "RatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchRatings_RaterId",
                table: "MatchRatings",
                column: "RaterId");
